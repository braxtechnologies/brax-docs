...
<div style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); padding: 1.75rem; border-radius: 10px; margin-bottom: 1.5rem; color: white;">
  ...
  <p style="margin: 0; opacity: .95;">When performance or behavior doesn't meet expectations, we provide structured support to get back on track—not punishment, but a path forward.</p>
</div>
...
<figure style="margin: 2rem 0; text-align: center;">
  <a href="/assets/images/cap.png" target="_blank">
    <img src="/assets/images/cap.png" alt="CAP Task Assignation Process" style="width: 100%; height: auto; cursor: pointer; display: block; margin: 0 auto;">
  </a>
  <figcaption style="margin-top: 0.5rem; font-style: italic; color: #666;">Task Assignation within Corrective Action Plan (click to enlarge)</figcaption>
</figure>
...
<div style="background: #e8f5e9; border-left: 4px solid #4caf50; padding: 1.5rem; border-radius: 8px; margin-bottom: 1.5rem;">
